...
def parse_command_line():
    ...
    parser.add_argument("-r","--radius", default = 3.0, help="Radius of the circle, in cm. \
        Default value: 3.0 cm")
    parser.add_argument("output", choices=["square","pentagon"], help="Choice of output object.")
    ...
    if l_output == "square":
        ...
        sys.exit("No further output objects have been implemented yet! Aborting...")
